...
const challenges = [
  ...
  },
  {
    ...
    difficulty: 'ALTO',
    reward: 'Instalación Supervisada · check-in diario revisado · acceso inmediato',
  ...
  },
  {
    ...
    difficulty: 'MEDIO',
    reward: 'Disponibles para quienes completan el Protocolo',
    cta: 'protocolo' as const,
  },
]
...
const tiers = [
  ...
  },
  {
    ...
    level: '01',
    desc: 'La Instalación Supervisada de 21 días. Check-in diario revisado, llamada 1:1 y reglas de expulsión. Acceso inmediato.',
    features: ['Protocolo día por día', 'Llamada 1:1 de arranque', 'Check-in diario revisado', 'Llamadas grupales', 'Sistema de puntos y rangos'],
    price: `$${funnel.priceUsd} USD`,
    ctaLabel: 'Ver el protocolo',
    ctaTo: '/protocolo',
    disabled: false,
  },
  {
